...
const InfoHeader = styled(H1)(tw`max-w-xs md:max-w-md lg:max-w-2xl`);
    ...
    return (
      <>
        <InfoSectionWrapper
          ...
          layout='grid'
        >
          <InfoSectionWrapper css={cell({ span: 12, md: 7 })} layout='flex'>
          ...
          <InfoSectionWrapper css={cell({ span: 12, md: 5 })} layout='flex'>
            <Echo />
          </InfoSectionWrapper>
        </InfoSectionWrapper>
      </>
